...
public class SendVcInformation implements JavaDelegate {
            ...
            if (user != null) {
                ...
                if (sender != null && !sender.isEmpty()) {
                    ...
                    try {
                        ...
                        email.setSubject("New VC Information");
                        email.setMsg("Dear CSP,\n\nWe are pleased to inform you about the creation of a new VC. Please find the relevant information attached or detailed below.\n\nBest regards,\nTeam");
